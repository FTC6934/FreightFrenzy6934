...
@Autonomous(name="B2 STORAGE", group="Blue")
public class B2Block extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // DROP ARM
        if (state == 50) {
                telemetry.addData("State", "50");
                telemetry.update();
                runtime = robot.armLift(0.2, 0, 10, runtime);
                while (opModeIsActive() &&
                        (robot.arm.isBusy())) {
                    telemetry.addData("Arm", robot.arm.getPower());
                    telemetry.addData("Arm Position", robot.arm.getCurrentPosition());
        ...
        if (state == 12) {
            ...
            runtime = robot.encoderDrive(1, -11,11,-11,11,10,runtime);
            while (opModeIsActive() && (robot.motorFL.isBusy() || robot.motorFR.isBusy() || robot.motorBL.isBusy() || robot.motorBR.isBusy())) {
                telemetry.addData("Path1", "Running to %7d :%7d", robot.newLeftTarget, robot.newRightTarget);
                telemetry.addData("Path2", "Running at %7d :%7d",
                        robot.motorFL.getCurrentPosition(),
        ...
        if (state == 13) {
            ...
            telemetry.update();
            runtime = robot.encoderDrive(1.0, -18, -18, -18, -18, 18, runtime);
            while (opModeIsActive() && (robot.motorFL.isBusy() || robot.motorFR.isBusy() || robot.motorBL.isBusy() || robot.motorBR.isBusy())) {
                telemetry.addData("Path1", "Running to %7d :%7d", robot.newLeftTarget, robot.newRightTarget);
                telemetry.addData("Path2", "Running at %7d :%7d",
                        robot.motorFL.getCurrentPosition(),
        ...
        if (state == 14) {
            ...
            telemetry.update();
            runtime = robot.encoderDrive(1,-6,-2,-6,-2,10,runtime);
            while (opModeIsActive() && (robot.motorFL.isBusy() || robot.motorFR.isBusy() || robot.motorBL.isBusy() || robot.motorBR.isBusy())) {
                telemetry.addData("Path1", "Running to %7d :%7d", robot.newLeftTarget, robot.newRightTarget);
                telemetry.addData("Path2", "Running at %7d :%7d",
                        robot.motorFL.getCurrentPosition(),
        ...
        if (state == 15) {
            ...
            telemetry.update();
            runtime = robot.encoderDrive(1, -1,-1,-1,-1,10,runtime);
        ...
        // ACTIVATE VUFORIA TO PARK IN STORAGE UNIT
        // USES ENCODER DRIVE IF IMAGE NOT FOUND
        if (state == 19){
            telemetry.addData("state", "19");
            telemetry.update();
            runtime = robot.goToImage(1,-12,10,runtime);
        ...
        if (state == 51) {
            telemetry.addData("State", "51");
            telemetry.update();
            runtime = robot.armLift(0.2, -500, 10, runtime);
            while (opModeIsActive() &&
                    (robot.arm.isBusy())) {
                telemetry.addData("Arm", robot.arm.getPower());
                telemetry.addData("Arm Position", robot.arm.getCurrentPosition());
        ...
        if (state == 28) {
            ...
            runtime = robot.encoderDrive(1, -10,10,-10,10,10,runtime);
            while (opModeIsActive() && (robot.motorFL.isBusy() || robot.motorFR.isBusy() || robot.motorBL.isBusy() || robot.motorBR.isBusy())) {
                telemetry.addData("Path1", "Running to %7d :%7d", robot.newLeftTarget, robot.newRightTarget);
                telemetry.addData("Path2", "Running at %7d :%7d",
                        robot.motorFL.getCurrentPosition(),
        ...
        if (state == 29) {
            ...
            telemetry.update();
            runtime = robot.encoderDrive(1.0, -18, -18, -18, -18, 15, runtime);
            while (opModeIsActive() && (robot.motorFL.isBusy() || robot.motorFR.isBusy() || robot.motorBL.isBusy() || robot.motorBR.isBusy())) {
                telemetry.addData("Path1", "Running to %7d :%7d", robot.newLeftTarget, robot.newRightTarget);
                telemetry.addData("Path2", "Running at %7d :%7d",
                        robot.motorFL.getCurrentPosition(),
        ...
        if (state == 52) {
            telemetry.addData("State", "50");
            telemetry.update();
            runtime = robot.armLift(0.2, -900, 10, runtime);
            while (opModeIsActive() &&
                    (robot.arm.isBusy())) {
                telemetry.addData("Arm", robot.arm.getPower());
                telemetry.addData("Arm Position", robot.arm.getCurrentPosition());
        ...
        if (state == 43) {
            ...
            telemetry.update();
            runtime = robot.encoderDrive(1.0, -15, -15, -15, -15, 15, runtime);
            while (opModeIsActive() && (robot.motorFL.isBusy() || robot.motorFR.isBusy() || robot.motorBL.isBusy() || robot.motorBR.isBusy())) {
                telemetry.addData("Path1", "Running to %7d :%7d", robot.newLeftTarget, robot.newRightTarget);
                telemetry.addData("Path2", "Running at %7d :%7d",
                        robot.motorFL.getCurrentPosition(),
