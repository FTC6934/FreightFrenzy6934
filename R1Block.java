...
@Autonomous(name="R1 WAREHOUSE", group="Blue")
public class R1Block extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (state == 11){
            ...
            telemetry.update();
            runtime = robot.encoderDrive(1,3,6,3,6,10,runtime);
            while (opModeIsActive() && (robot.motorFL.isBusy() || robot.motorFR.isBusy() || robot.motorBL.isBusy() || robot.motorBR.isBusy())) {
                telemetry.addData("Path1", "Running to %7d :%7d", robot.newLeftTarget, robot.newRightTarget);
                telemetry.addData("Path2", "Running at %7d :%7d",
                        robot.motorFL.getCurrentPosition(),
        ...
        if (state == 13){
            ...
            telemetry.update();
            runtime = robot.encoderDrive(1,-20,-20,-20,-20,10,runtime);
            while (opModeIsActive() && (robot.motorFL.isBusy() || robot.motorFR.isBusy() || robot.motorBL.isBusy() || robot.motorBR.isBusy())) {
                telemetry.addData("Path1", "Running to %7d :%7d", robot.newLeftTarget, robot.newRightTarget);
                telemetry.addData("Path2", "Running at %7d :%7d",
                        robot.motorFL.getCurrentPosition(),
        ...
        if (state == 15) {
            ...
            telemetry.update();
            runtime = robot.encoderDrive(1, -3, 2, -3, 2, 10, runtime);
            while (opModeIsActive() && (robot.motorFL.isBusy() || robot.motorFR.isBusy() || robot.motorBL.isBusy() || robot.motorBR.isBusy())) {
                telemetry.addData("Path1", "Running to %7d :%7d", robot.newLeftTarget, robot.newRightTarget);
                telemetry.addData("Path2", "Running at %7d :%7d",
                        robot.motorFL.getCurrentPosition(),
        ...
        if (state == 17) {
            ...
            while (runtime.seconds() < 2){
                telemetry.addLine("Checking 3rd position");
            }
            state = 24;
        }
